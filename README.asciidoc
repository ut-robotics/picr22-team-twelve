...
Pille:: Filling in the project time planning tool, sending to other team members (30min).

=== 06.10

Pille:: Cleaning up the main.py file, moving serial connection to motion class. Starting with driving logic. (30min)
