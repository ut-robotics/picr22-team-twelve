...
The `main.py` holds the state machine for the driving logic. For configurations check the software branch readme file. The overall logic of the code is as follows:
